...
- [my-project-template-walkthrough](https://git.generalassemb.ly/ga-wdi-boston/my-project-template-walkthrough)

## Installation

1. [Download](../../archive/master.zip) this template.
1. Unzip and rename the template directory (`unzip ~/Downloads/my-project-template-master.zip`).
1. Move into the new project and `git init`.
1. Empty [`README.md`](README.md) and fill with your own content.
1. Replace all instances of `my-project` with your app name. This
    includes:
...
To deploy an my-project-template based SPA, run `grunt deploy`.
